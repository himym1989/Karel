...
public class MyArrayList<E> {
    ...
    /**
     * Method implements adding element at the end of the list;
     ...
     * increases capacity if it is needed;
     *
    ...
    /**
     * Method implements adding an element at the specific index;
    ...
    /**
     * Method implements setting new value to the element at the specific index;
     *
     * @param index   - int, index of the cell, which value will be changed;
     * @param element - E, new value of the element;
     */
     ...
     * if index is equal to size or bigger, an exception is thrown;
     *
     ...
     * @return - removed element at the specific index;
     */
