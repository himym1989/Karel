...
public class Assignment15Part1 {
    ...
    // 1.txt.par 1new.txt
    private static final String DEFAULT_IN_FILE = "tomsawyer.txt";
    private static final String DEFAULT_OUT_FILE = "tomsawyer.txt.par";

    private static final String FLAG_ARCHIVE = "-a";
    private static final String FLAG_UNARCHIVE = "-u";

    public static void main(String[] args) {
        System.out.println(ANSI_YELLOW + "Start Huffman compressing on Java collections" + ANSI_RESET);
